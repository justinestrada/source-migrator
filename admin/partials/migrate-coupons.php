...
<form id="import-coupons-form" method="post" action="<?php echo get_site_url(); ?>/wp-admin/tools.php?page=source-migrator&tab=migrate-product-reviews" style="margin-bottom: 1rem;">
  <div id="import-alert" class="alert" role="alert" style="display: none;"></div>
  <p>Import coupons from remote website.</p>
